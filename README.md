...
# Unmaintained
## Bunny Girls
Adds a built-in command to post a random gif of a bunny girl in chat. Based off [this](https://github.com/yofukashino/BetterDiscordPlugins/blob/master/BunnyGirls.plugin.js)
...
## QuestsHomeNav (Probably broken use [questify](https://github.com/EtorixDev/questify))
